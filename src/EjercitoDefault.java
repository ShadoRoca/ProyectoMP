/**
 * Representa el ejercito default
 */
public class EjercitoDefault extends Ejercito {
    ...
    public EjercitoDefault() {
        ...
        comandante2.add(new Artilleria("202", "Lizbeth", 100));
        comandante2.add(new Artilleria("203", "Lucas", 100));
        //Crea el tercer peloton
